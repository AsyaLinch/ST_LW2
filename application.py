...
class Calculator:
    ...
    def frequency_of_treatment(self, T):
        if T <= 0:
            raise ValueError("Период не может быть меньше или равен нулю")
        return 1 / T
    ...
    def linear_velocity(self, S, t):
        if t <= 0:
            raise ValueError("Время не может быть меньше или равен нулю")
        return S / t

    def linear_velocity_period(self, r, T):
        if T <= 0:
            raise ValueError("Период не может быть меньше или равен нулю")
        return (2 * 3.14 * r) / T
    ...
    def centripetal_acceleration(self, V, r):
        if r <= 0:
            raise ValueError("Радиус не может быть меньше или равен нулю")
        return (V ** 2) / r
    ...
    def choice(self):
        ...
        if input_string == 1:
            ...
            t = float(input("Введите время: "))
            return self.linear_velocity(S, t)

        elif input_string == 5:
            r = float(input("Введите радиус: "))
            T = float(input("Введите период: "))
            return self.linear_velocity_period(r, T)
...
class TestCalculator(unittest.TestCase):
    ...
    def test_linear_velocity(self):
        self.assertEqual(self.calculator.linear_velocity(2, 2), 1)
        self.assertEqual(self.calculator.linear_velocity(3, 3), 1)

    def test_linear_velocity_period(self):
        self.assertAlmostEqual(self.calculator.linear_velocity_period(2, 2), 6.28, places=2)
        self.assertAlmostEqual(self.calculator.linear_velocity_period(3, 3), 6.28, places=2)
